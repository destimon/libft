...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/03/27 15:35:09 by dcherend          #+#    #+#              #
#    Updated: 2018/03/27 15:45:12 by dcherend         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJ = ft_bzero.o ft_memcpy.o ft_memccpy.o ft_strcpy.o ft_strcat.o ft_strchr.o \
      ft_strrchr.o ft_strcmp.o ft_isprint.o ft_strncpy.o ft_strncat.o \
      ft_isascii.o ft_strncmp.o ft_memchr.o ft_strnstr.o ft_atoi.o \
      ft_memcmp.o ft_strlen.o ft_strlcat.o ft_memalloc.o ft_memdel.o \
      ft_strnew.o ft_strdel.o ft_strclr.o ft_strstr.o ft_strmap.o ft_striter.o \
      ft_striteri.o ft_strmapi.o ft_strequ.o ft_strnequ.o ft_strsub.o \
      ft_strjoin.o ft_strtrim.o ft_putchar.o ft_putstr.o ft_putendl.o \
      ft_putnbr.o ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o \
      ft_putnbr_fd.o ft_strsplit.o ft_memmove.o ft_strdup.o ft_tolower.o \
      ft_toupper.o ft_isdigit.o ft_isalnum.o ft_isalpha.o ft_itoa.o ft_memset.o \
      ft_lstnew.o ft_lstdelone.o ft_lstadd.o
all: $(NAME)
$(NAME):
